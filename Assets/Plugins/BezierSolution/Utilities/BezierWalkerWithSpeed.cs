...
namespace BezierSolution
{
	...
	public class BezierWalkerWithSpeed : BezierWalker
	{
		...
		public override void Execute( float deltaTime )
		{
			...
			transform.position = Vector2.Lerp(transform.position, targetPos, movementLerpModifier * deltaTime);
		...
		public IEnumerator StopWalkerForSeconds(float timeForStop)
		{
			isStopped = true;

			var speedOfWalker = speed;
			speed = 0;
